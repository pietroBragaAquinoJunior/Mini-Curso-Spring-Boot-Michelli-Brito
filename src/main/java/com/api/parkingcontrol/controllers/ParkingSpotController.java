...
public class ParkingSpotController {
	...
	@GetMapping
	public ResponseEntity<Page<ParkingSpotModel>> getAllParkingSpots(@PageableDefault Pageable pageable){
	...
	public ResponseEntity<Object> getOneParkingSpot(@PathVariable UUID id){
		...
		return ResponseEntity.ok().body(parkingSpotModelOptional.get());
	}
